import React, { useRef, CSSProperties, useState, useEffect, MouseEvent, TouchEvent } from 'react';
...
const Label: React.FC<Props> = ({ style }) => {
  // Element References
  ...
  return (
    <label ref={elementRef} className={styles.Label} style={style}>
      Label
    </label>
  );
};
